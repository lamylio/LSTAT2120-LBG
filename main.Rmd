...
```{r descriptive_table, out.width="80%", eval=T}
...
# Print desc
desc.quantitative = compute.desc.quantitative(dataset)
print(formattable(desc.quantitative, align=c("l", rep("c", ncol(desc.quantitative)-1))))
...
print(formattable(models.comparison, list(
  formattable::area(row=choice) ~ formatter("span", style= ~ style(font.weight="bold"))
)))
...
print(formattable(models.comparison, align=c("l", "c")))
...
print(formattable(p, align=c("l", "c", "c")))
