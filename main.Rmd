...
dummies = data.frame(model.matrix(~ Nationality - 1, data=original), 
                     Preferred_FootLeft = model.matrix(~ Preferred_Foot - 1, data=original)[,1])
...
# dataset.age_cut = within(clean_dataset, {
...
# Stepwise AIC
aic.step = ols_step_both_aic(model.complete.logy, T, F)
