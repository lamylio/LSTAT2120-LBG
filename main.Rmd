...
All our coefficients are significant at a $alpha$−level 0.01. We note that all the coefficients estimates $\beta_j$ have a positive sign, apart from <i>NationalityAmerica</i> and the intercept. In fact, beeing American seem to lower your salary by 890\$. Being Asian, conversely, increases your wage by 1200\$. An explantion for that could be that rising clubs in country like Qatar or Saudi Arabia recruits manly asian players, and pay them well. The explanation for the coefficient of <i>NationalityAmerica</i> could be that South American players are more keen to accept lwer salaries, since these countries have lower income level on average.
...
```{r, eval=F}
linearHypothesis(model, c("Reactions=0", "Composure=0"))
```
