...
```{r}
#Residuals vs fitted
t = ols_plot_resid_fit(model, print_plot = F)
t$layers[[1]]$aes_params$colour = opt.barcolor
t$layers[[1]]$aes_params$shape = 16
t$layers[[2]]$aes_params$colour = "black"
t$theme = theme(
...
```{r}
t = ols_plot_resid_qq(model, print_plot = F)
t$layers[[1]]$aes_params$colour = opt.barcolor
t$layers[[2]]$aes_params$colour = "black"
t$theme = theme(
 panel.grid.major = element_blank(), 
