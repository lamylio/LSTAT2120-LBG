...
formula.aic = as.formula("log(Wage) ~ Overall + Potential + Weight + HeadingAccuracy + 
...
lasso.cv = cv.glmnet(x=data.matrix(within(train, {Wage = NULL})), y = log(train$Wage), family = "gaussian", alpha = 1)
