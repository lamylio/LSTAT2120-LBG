...
We will now start to select variables to include in our model. We will use the two following types of model selction : a stewise selection using AIC and a LASSO proceure.
...
model = lm(formula.complete, data=clean_dataset)
